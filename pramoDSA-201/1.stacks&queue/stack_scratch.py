...
class ArrayStack:
    def __init__(self, size):
        self.capacity = size   #allocation of the size of the stack
        self.top = -1
...
if __name__ == "__main__":
    ...
    print(s.pop())   # 30 <- topmost element
    print(s.peek())  # 20 <- new topmost element
    print(s.get_size())  # 2 <- size of the stack after popping one element