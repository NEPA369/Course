# 4. Write a program to show linear, quadratic probing and double hashing
class Hashing:
...
if __name__ == "__main__":
    demo = Hashing(10)
    keys_linear = [16, 22, 32]   # collisions at index 2
    keys_quadratic = [5, 25, 35] # collisions at index 5
    keys_double = [8, 9, 50]    # collisions at index 8
